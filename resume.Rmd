...
Technical: R, SQL, SAS, Microsoft Excel, Microsoft PowerPoint, Microsoft Access, Adobe Creative Suite & Office 365, Mplus, Geographic Information Systems (GIS), IBM SPSS, InDesign, Vensim, Qualtrics, Dedoose, Python

---

###**WORK EXPERIENCE**

**NYU Langone Health, Research Analyst**  *June 2019 – Current*

*	Clean and conduct statistical analyses on data related to various co-occurring health conditions for HIV patients, retrieved from the Veterans Aging Cohort Study (VACS)

*	Manipulate large datasets in R and develop optimal data visualization of results (i.e. graphs, figures, tables, grids, etc.)

*	Perform systematic literature reviews to provide inputs for modeling the cost-effectiveness and success of strategies aimed at optimizing and improving health
